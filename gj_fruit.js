...
[task_local]
#jd免费水果
10 6-18/6 * * * gj_fruit.js, tag=东东农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "10 6-18/6 * * *" script-path=gj_fruit.js,tag=东东农场
=========================Surge============================
东东农场 = type=cron,cronexp="10 6-18/6 * * *",wake-system=1,timeout=3600,script-path=gj_fruit.js
=========================小火箭===========================
